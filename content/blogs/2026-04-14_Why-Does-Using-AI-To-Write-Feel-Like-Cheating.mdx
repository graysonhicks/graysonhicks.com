...
description: I use AI to write code all day without guilt. Using it to write prose felt like cheating. Why does the same tool feel so different depending on what you're creating?
date: '2026-04-14T12:00:00.000Z'
categories: ['AI', 'Writing']
keywords: ['AI writing', 'AI assisted writing', 'AI coding vs writing', 'AI guilt', 'AI creativity', 'LLM writing', 'writer block', 'AI content creation', 'AI ethics', 'AI self-expression']
