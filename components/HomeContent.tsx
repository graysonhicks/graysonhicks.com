...
export default function HomeContent({ latestPost }: HomeContentProps) {
            ...
            >
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-mono text-[13px] md:text-[14px] tracking-wider text-gray-200 group-hover:text-cyber-magenta transition-colors mb-1.5">
                    {latestPost.title}
                  </h3>
                  {latestPost.description && (
                    <p className="text-[11px] text-gray-500 leading-relaxed mb-2 line-clamp-2 group-hover:text-gray-400 transition-colors">
                      {latestPost.description}
                    </p>
                  )}
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                    ...
                    {latestPost.categories && latestPost.categories.length > 0 && (
                      <div className="flex gap-1.5">
                        {latestPost.categories.slice(0, 3).map((cat) => (
                          <span
                            key={cat}
                            className="px-1.5 py-0.5 text-[8px] font-mono tracking-widest border border-fuchsia-400/15 text-fuchsia-400/50"
                          >
                            {cat}
                          </span>
                        ))}
